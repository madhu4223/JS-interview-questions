...
// In JavaScript, a closure is like a special key that allows a function to remember and access the variables from the scope where it was created, even after that scope has finished running. 
// Just like your special key can open the box with the secret code inside, a closure allows a function to access variables from its parent function, even if that parent function has already finished running.
